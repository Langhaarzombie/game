...
public class Buildings {
	...
	public boolean newBuild(int wood, int clay, int iron, int gold, int people, int schoolMultiplicator){
		if(wood-this.costsWood>=0)		wood=wood-this.costsWood;
		else return false;
		if(clay-this.costsClay>=0)		clay=clay-this.costsClay;
		else return false;
		if(iron-this.costsIron>=0)		iron=iron-this.costsIron;
		else return false;
		if(gold-this.costsGold>=0)		gold=gold-this.costsGold;
		else return false;
		if(people-this.costsPeople>=0)	people=people-this.costsPeople;
		else return false;
		...
		gold=gold+this.plusGold*this.plusPeople;
