...
public class ClayPit
{
    ...
    // constructor
    public ClayPit(View view, String name, int costsWood, int costsClay, int costsIron, int costsGold, int costsPeople, int plusWood, int plusClay, int plusIron, int plusGold, int plusPeople, int special1, int special2)
    {
        this.view=view;
        int max=0;
